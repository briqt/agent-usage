...
const I18N = {
  en: {
    ...
    model: 'Model', calls: 'Calls', allSources: 'All Sources', allModels: 'All Models', claudeCode: 'Claude Code', codex: 'Codex', openClaw: 'OpenClaw', openCode: 'OpenCode', kiro: 'kiro', pi: 'Pi', omp: 'Oh My Pi', grok: 'Grok Build', hermes: 'Hermes',
  ...
  zh: {
    ...
    model: '模型', calls: '调用次数', allSources: '全部来源', allModels: '全部模型', claudeCode: 'Claude Code', codex: 'Codex', openClaw: 'OpenClaw', openCode: 'OpenCode', kiro: 'kiro', pi: 'Pi', omp: 'Oh My Pi', grok: 'Grok Build', hermes: 'Hermes',
...
function buildControls() {
  ...
  const SOURCES = [['', 'allSources'], ['claude', 'claudeCode'], ['codex', 'codex'], ['opencode', 'openCode'], ['pi', 'pi'], ['omp', 'omp'], ['grok', 'grok'], ['kiro', 'kiro'], ['hermes', 'hermes'], ['openclaw', 'openClaw']];
